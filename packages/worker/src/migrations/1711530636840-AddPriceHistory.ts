...
export class Migrations1711530636840 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "priceHistory" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" BIGSERIAL NOT NULL, "l2Address" bytea NOT NULL, "usdPrice" double precision, "timestamp" TIMESTAMP NOT NULL, CONSTRAINT "PK_cefd61c8c95eb4b9c8e11ed352f" PRIMARY KEY ("id"))`
    );
