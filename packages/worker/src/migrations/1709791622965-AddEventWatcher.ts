...
export class AddEventWatcher1709791622965 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_9e475a3d90c4eb770510437d05" ON "batchRootEventLogs" ("rootHash", "chainId") `
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_11d1f42e3b67f849213d2ce7bf" ON "eventProcess" ("topic", "chainId", "contractAddress") `
    );
    await queryRunner.query(
