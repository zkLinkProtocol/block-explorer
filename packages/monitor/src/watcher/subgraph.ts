export async function findETHMasterListAndAmount() {
  ...
  try {
    const response = await fetch(
      'https://api.studio.thegraph.com/query/71364/zkl/version/latest',
      {
        method: 'POST',
    ...
    return {
      holders: [
        ...
        {
          accountType: 'master',
          balance: '815721845978803468000000',
        ...
        {
          accountType: 'master',
          balance: '425931472811917697395664',
        ...
        {
          accountType: 'master',
          balance: '1416676542000000000000',
